...
const tourSteps = [
  ...
  },
  {
    view: "seguridad",
    target: "permisos",
    title: "7. Administrar permisos",
    text: "Permisos muestra las personas con acceso, permite editar roles y centraliza la bitácora de cambios de ciudades logísticas, Divipoles y plantas.",
  },
];
...
loginBtn.addEventListener("click", () => {
  ...
  showToast("Sesión corporativa validada");
